      ...
      <template slot="comment">
        <div class="comment_header">
          ...
          <span class="btn_wrap">
            <span
              class="modify_btn"
              v-if="userStore_token.info.user_id == list.reviews.user_id"
            ...
            >
            <span
              v-if="userStore_token.access_token"
              @click="
                editor = index;
                id = list.reviews.id;
              "
        ...
        <div class="edit_wrap" v-if="editor == index">
          <textarea
          ...
          <template slot="comment">
            <div class="comment_header">
              ...
              <span class="btn_wrap">
                <span
                  class="modify_btn"
                  v-if="userStore_token.info.user_id == reply.user_id"
                  @click="reply_editor = reply.id"
                  >수정</span
                >
                <span v-if="userStore_token.info.user_id == reply.user_id"
                  >삭제</span
                >
              </span>
            </div>
            ...
            <div
              class="edit_wrap"
              v-show="
                userStore_token.info.user_id == reply.user_id &&
                  reply.id == reply_editor
              "
            >
              <textarea
                placeholder="내용을 입력해주세요.(300자)"
