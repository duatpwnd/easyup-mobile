(function(global, factory) {
  ...
  var addGlobalStyles = function(document) {
    ...
    style.innerHTML =
      ...
      CSS.CLASS +
      " span { padding: 1px 4px; display: inline-block; margin-bottom: 2px; }\n    ." +
      CSS.CLASS +
      "." +
  ...
  var Subtitle = /** @class */ (function() {
    ...
    Subtitle.prototype.render = function() {
      ...
      if (this.player) {
        ...
        this.element.children[0].style.color = "#333333";
        this.element.children[0].style.padding = "1px 4px";
        this.element.children[0].style.lineHeight = "normal";
        this.element.children[0].style.borderRadius = "5px";
        ...
        this.element.style.bottom = "0" - this.element.offsetHeight - 20 + "px";
        ...
        this.element.style.left =
          frame.x + (frame.width - this.element.offsetWidth) / 2 + "px";
    ...
    Subtitle.prototype.getCurrentVideoId = function() {
      // this.state.duration_time = this.player.getDuration();
